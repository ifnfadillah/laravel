            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
                    <div class="max-w-xl lg:max-w-lg">
                        <h2 class="text-4xl font-bold tracking-tight text-white sm:text-4xl">About Me</h2>
                        <p class="mt-4 text-lg font-semibold leading-8 text-gray-300">I'll try to learn about Laravel 11 features to explore my knowledge in framework.</p>
                    ...
                    <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                        <div class="flex flex-col items-start">
                            ...
                            <div class="mt-2 bg-blue-500 py-2 px-4 rounded-lg text-center text-sm font-semibold text-white"> <a href="/blog">See Blog</a>
                            </div> 
                        </div>
                        <div class="flex flex-col items-start">
                            <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                            ...
                            <dt class="mt-4 font-semibold text-white">Contact</dt>
                            <dd class="mt-2 leading-7 text-gray-400">Officia excepteur ullamco ut sint duis proident non
                                ...
                                <div class="mt-2 bg-blue-500 py-2 px-4 rounded-lg text-center text-sm font-semibold text-white"> <a href="/contact">See Contact</a>
                            </div> 
                        </div>
                    </dl>
                </div>
